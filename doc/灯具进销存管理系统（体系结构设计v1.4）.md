...
|  胡本霖    | 2018/1/5   | 修改了inventory、goods、classification相关 业务逻辑层及数据层接口 | v1.3 |
...
<table>
   ...
   <tr>
    	<td rowspan="3">FormBLService.getSalesDetails</td>
        <td>语法</td>
    ...
    <tr>
     ...
     <tr>
    	<td rowspan="3">FormBLService.getDocumentDetails</td>
        <td>语法</td>
        <td>public ArrayList&lt;BillVO&gt; getDocumentDetails(DocumentDetailsInput input);</td></tr>
    <tr>
    	<td>前置条件</td>
        <td>符合输入规则</td></tr>
    <tr>
     ...
     <tr>
    	<td rowspan="3">FormBLService.getProfit</td>
        <td>语法</td>
    ...
    <tr>
     ...
     <tr>
    	<td rowspan="3">FormBLService.redCover</td>
        <td>语法</td>
    ...
    <tr>
     ...
     <tr>
    	<td rowspan="3">FormBLService.redCopy</td>
        <td>语法</td>
    ...
    <tr>
        ...
        <td>系统将指定单据红冲并复制</td>
         ...
         <tr>
    	<td rowspan="3">FormBLService.exportSalesDetails</td>
        <td>语法</td>
        <td>public ResultMessage exportSalesDetails(String filePath, String filename, ArrayList&lt;SalesDetailVO&gt; salesDetailVOS);</td></tr>
    <tr>
    	<td>前置条件</td>
    ...
    <tr>
        ...
        <td>系统将销售明细表导出</td>
             ...
             <tr>
    	<td rowspan="3">FormBLService.exportDocumentDetails</td>
        <td>语法</td>
        <td>public ResultMessage exportDocumentDetails(String filePath,ArrayList&lt;BillVO&gt; vos);</td></tr>
    <tr>
    	<td>前置条件</td>
    ...
    <tr>
        ...
        <td>系统将经营历程表导出</td>
                 ...
                 <tr>
    	<td rowspan="3">FormBLService.exportProfit</td>
        <td>语法</td>
        <td> public ResultMessage exportProfit(String filePath,String filename,ArrayList&lt;ProfitVO&gt; vos);</td></tr>
    <tr>
    	<td>前置条件</td>
    ...
    <tr>
        ...
        <th colspan="2">服务</th>
         ...
         <tr>
        <td>SalesInfo.getAllSalesOrder(String startDate,String endDate);</td>
        <td colspan="2">得到所有销售出货单</td>
        </tr>
        <tr>
        <td>SalesInfo.getAllSalesReturnOrder(String startDate,String endDate);</td>
        <td colspan="2">得到所有销售退货单</td>
        </tr>
        <tr>
        <td>SalesInfo.redCover(SalesVO vo)</td>
        <td colspan="2">生成红冲单据</td>
        </tr>
        <tr>
        <td>SalesInfo.redCoverAndCopy(SalesVO vo)</td>
        <td colspan="2">生成红冲单据和复制单据</td>
        </tr>
         <tr>
        <td>PurchaseInfo.getPurchaseByDate(String startDate,String endDate);</td>
        <td colspan="2">根据日期得到进货单据</td>
        </tr>
         <tr>
        <td>PurchaseInfo.redCover(PurchaseVO vo);</td>
        <td colspan="2">红冲进货单据</td>
        </tr>
        <tr>
        <td>PurchaseInfo.redCoverAndCopy(PurchaseVO vo);</td>
        <td colspan="2">生成红冲单据和复制单据</td>
        </tr>
        <tr>
        <td>FinanceInfo.getAccountBillsByDate(String startDate,String endDate);</td>
        <td colspan="2"> 获得所有审批通过的收付款单</td>
        </tr>
        <tr>
        <td>FinanceInfo.redCover(BillVO billVO)</td>
        <td colspan="2"> 红冲单据</td>
        </tr>
        <tr>
        <td>FinanceInfo.redCoverAndCopy(BillVO billVO);</td>
        <td colspan="2"> 红冲并复制单据</td>
        </tr>
        <tr>
        <td>InventoryInfo.getInventoryBillsByDate(String startDate, String endDate);</td>
        <td colspan="2"> 根据日期获得已经审批通过的库存报溢单、库存报损单</td>
        </tr>
         <tr>
        <td>InventoryInfo.redCover(BillVO billVO)</td>
        <td colspan="2"> 红冲单据</td>
        </tr>
         <tr>
        <td>InventoryInfo.redCoverAndCopy(BillVO billVO);</td>
        <td colspan="2"> 红冲并复制单据</td>
        </tr>
         <tr>
        <td>CustomerInfo.getCustomerByID(int ID);</td>
        ...
        <tr>
        <td>PromotionTotalInfo.findPromotionByName(String promotionName);</td>
        <td colspan="2">通过促销策略名得到总价促销策略</td>
        </tr>
         <tr>
        <td>PromotionCustomerInfo.findPromotionByName(String promotionName);</td>
        <td colspan="2">通过促销策略名得到会员促销策略</td>
        </tr>
...
<table>
   ...
   <tr>
    	<td rowspan="3">LogBLService.show</td>
        <td>语法</td>
        <td>public ArrayList&lt;String&gt; show()</td></tr>
    <tr>
    	<td>前置条件</td>
        <td>无</td></tr>
    <tr>
   ...
   <tr>
    	<td rowspan="3">LogBLService.getLogByDate</td>
        <td>语法</td>
        <td>public ArrayList&lt;String&gt; getLogByDate(LocalDateTime start, LocalDateTime end)</td></tr>
    <tr>
    	<td>前置条件</td>
        <td>日期时间输入正确</td></tr>
    <tr>
   ...
   <tr>
    	<td rowspan="3">LogBLInfo.record</td>
        <td>语法</td>
        <td>public ResultMessage record(OperationType operationType, OperationObjectType operationObjectType, String details)</td></tr>
    <tr>
    	<td>前置条件</td>
        <td>操作信息和详情输入正确</td></tr>
    <tr>
   		<td>后置条件</td>
        <td>添加日志记录，持久化更新涉及的对象的数据</td>
    </tr>
   <tr>
    	<td rowspan="3">LogBLInfo.close</td>
        <td>语法</td>
        <td>public ResultMessage close()</td></tr>
    <tr>
    	<td>前置条件</td>
        <td>无</td></tr>
    <tr>
   ...
   <tr>
    	<td rowspan="3">LogBLInfo.open</td>
        <td>语法</td>
        <td>public ResultMessage open()</td></tr>
    <tr>
    	<td>前置条件</td>
        <td>无</td></tr>
    <tr>
   ...
   <tr>
    ...
    <tr>
        ...
        <th colspan="2">服务</th>
         ...
         <tr>
        <td>LogDataService.show()</td>
        <td colspan="2">得到所有日志记录</td>
        </tr>
         <tr>
        <td>LogDataService.getLogByDate(LocalDateTime start, LocalDateTime end)</td>
        <td colspan="2">根据时间日期得到日志记录</td>
        </tr>
         <tr>
        <td>LogDataService.addLog(LogPO po)</td>
        <td colspan="2">添加单一持久化对象</td>
        </tr>
</table>
...
* 表5.3.2-4 AccountDataService模块的接口规范
  ...
  <tr>
    <td rowspan="3">AccountDataService.addAccount</td>
    <td>语法</td>
    <td>public ResultMessage addAccount(AccountPO po) throws RemoteException;</td></tr>
  <tr>
    <td>前置条件</td>
    <td>同样的po在数据中不存在</td></tr>
  <tr>
   ...
   <tr>
    <td rowspan="3">AccountDataService.deleteAccount</td>
    <td>语法</td>
    <td>public void deleteAccount(AccountPO po) throws RemoteException;</td></tr>
  <tr>
    <td>前置条件</td>
  ...
  <tr>
    <td rowspan="3">AccountDataService.updateAccount</td>
    <td>语法</td>
    <td>public void updateAccount(AccountPO po) throws RemoteException;</td></tr>
  <tr>
    <td>前置条件</td>
    <td>在数据库中存在同样ID的PO</td></tr>
  <tr>
  ...
  <tr>
    ...
    <td>语法</td>
    <td>public AccountPO findByName(String keyword) throws RemoteException;</td></tr>
  <tr>
    <td>前置条件</td>
    <td>无</td></tr>
  <tr>
    <td>后置条件</td>
    <td>按名称进行查找返回相应的AccountPO结果</td>
  </tr>
  <tr>
...
* 表5.3.2-5 FinanceDataService模块的接口规范
  ...
  <tr>
   ...
   <tr>
      <td rowspan="3">FinanceDataService.addBill</td>
      <td>语法</td>
      <td>public ResultMessage addBill(BillPO po) throws RemoteException;</td></tr>
    <tr>
      <td>前置条件</td>
      <td>同样ID的po在数据库中不存在</td></tr>
    <tr>
      <td>后置条件</td>
      <td>增加一个PO</td>
    </tr>
  <tr>
    <td rowspan="3">FinanceDataService.deleteBill</td>
    <td>语法</td>
    <td>public ResultMessage deleteBill(BillPO po) throws RemoteException;</td></tr>
  <tr>
    <td>前置条件</td>
    <td>在数据库中存在同样的PO</td></tr>
  <tr>
  ...
  <tr>
    <td rowspan="3">FinanceDataService.updateBill</td>
    <td>语法</td>
    <td>public ResultMessage updateBill(BillPO po) throws RemoteException;</td></tr>
  <tr>
    <td>前置条件</td>
    <td>在数据库中存在同样ID的PO</td></tr>
  <tr>
   ...
   <tr>
    <td rowspan="3">FinanceDataService.getAllAccountBills</td>
    <td>语法</td>
    <td>public ArrayList&lt;AccountBillPO&gt; getAllAccountBills() throws RemoteException;</td></tr>
  <tr>
    <td>前置条件</td>
    <td>无</td></tr>
  <tr>
    <td>后置条件</td>
    <td>返回所有的AccountBillPO</td>
  </tr>
   <tr>
      <td rowspan="3">FinanceDataService.getAllCashBills</td>
      <td>语法</td>
      <td>public ArrayList&lt;CashBillPO&gt; getAllCashBills() throws RemoteException;</td></tr>
    <tr>
      <td>前置条件</td>
      <td>无</td></tr>
    <tr>
      <td>后置条件</td>
      <td>返回所有的CashBillPO</td>
    </tr>
  <tr>
...
* 表5.3.2-7 InitializationDataService模块的接口规范
  ...
  <tr>
        ...
        <td>语法</td>
        <td>public ResultMessage init(InitializationPO po) throws RemoteException;</td></tr>
    <tr>
    	<td>前置条件</td>
        <td>无</td></tr>
    <tr>
   ...
   <tr>
    	<td rowspan="3">InitializationDataService.getAllInitDates</td>
        <td>语法</td>
        <td>public ArrayList&lt;String&gt; getAllInitDates() throws RemoteException;</td></tr>
    <tr>
    	<td>前置条件</td>
        <td>无</td></tr>
    <tr>
    ...
    <tr>
        <td rowspan="3">InitializationDataService.getInitializationByDate</td>
        <td>语法</td>
        <td>public InitializationPO getInitializationByDate(String date) throws RemoteException;</td></tr>
    <tr>
        <td>前置条件</td>
        <td>存在期初建账日期</td></tr>
    <tr>
        <td>后置条件</td>
        <td>返回建账日期为该日期的期初建账</td>
    </tr>
  </table>
...
* 表5.3.2-11 LogDataService模块的接口规范
  <table>
  <tr>
  	<th colspan="3" align="center">提供的服务（供接口）</th>
  </tr>
  <tr>
    	<td rowspan="3">LogDataService.show</td>
        <td>语法</td>
        <td>public ArrayList&lt;LogPO&gt; show() throws RemoteException;</td></tr>
    <tr>
    	<td>前置条件</td>
        <td>无</td></tr>
    <tr>
  ...
  <tr>
    	<td rowspan="3">LogDataService.getLogByDate</td>
        <td>语法</td>
        <td>public ArrayList&lt;LogPO&gt; getLogByDate(LocalDateTime start, LocalDateTime end) throws RemoteException;</td></tr>
    <tr>
    	<td>前置条件</td>
        <td>日期时间输入正确</td></tr>
    <tr>
   		<td>后置条件</td>
        <td>根据日期时间返回所有日志记录的po对象</td>
    </tr>
  <tr>
    	<td rowspan="3">LogDataService.addLog</td>
        <td>语法</td>
        <td>public ResultMessage addLog(LogPO po) throws RemoteException;</td></tr>
    <tr>
    	<td>前置条件</td>
        <td>日期时间输入正确</td></tr>
    <tr>
...
|  **logPO**   | **记录时间、操作员ID、操作类型、操作对象类型、对象详情**  |



## 6.2 数据库表

数据库中包含Classification表、Goods表、Inventory表、InventoryBill表、Customer表、Purchase表、Sales表、Account表、GoodsItem表、AccountBill表、AccountBillItem表、CashBill表、CashBillItem表、Initialization表、InitAccount表、InitClassification表、InitCustomer表、InitGoods表、User表、PromotionCustomer表、PromotionBargain表、PromotionTotal表、Log表
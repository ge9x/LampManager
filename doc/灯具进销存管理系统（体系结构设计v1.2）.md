...
数据库中包含Classification表、Goods表、Inventory表、InventoryBill表、Customer表、Purchase表、Sales表、Account表、GoodsItem表、AccountBill表、AccountBillItem表、CashBill表、CashBillItem表、Initialization表、InitAccount表、InitClassification表、InitCustomer表、InitGoods表、User表、PromotionCustomer表、PromotionBargain表、PromotionTotal表
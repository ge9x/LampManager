...
| inventoryblservice        |                                          |
| inventorybl               | inventoryblservice,inventorydataservice,goodsbl, salesbl |
...
![图 5.2-1](http://101.37.19.32:10080/horizon/LampManager/raw/develop/doc/img/%E4%BD%93%E7%B3%BB%E7%BB%93%E6%9E%84%E8%AE%BE%E8%AE%A1%E5%9B%BE/%E4%BD%93%E7%B3%BB%E7%BB%93%E6%9E%84%E8%AE%BE%E8%AE%A1%E5%9B%BE%205.2-1.png)
...
![图5.3-1](http://101.37.19.32:10080/horizon/LampManager/raw/develop/doc/img/%E4%BD%93%E7%B3%BB%E7%BB%93%E6%9E%84%E8%AE%BE%E8%AE%A1%E5%9B%BE/%E4%B8%9A%E5%8A%A1%E9%80%BB%E8%BE%91%E5%B1%82%E5%88%86%E8%A7%A3%E5%9B%BE%205.3-1.png)
...
* 表 5.3.2-1 inventorybl模块的接口规范
  ...
  <tr>
    	<td rowspan="3">Inventory.showInventory</td>
        <td>语法</td>
  ...
  <tr>
    	<td rowspan="3">Inventory.show</td>
        <td>语法</td>
        <td>public InventoryViewVO show(Date startDate, Date endDate, String account);</td></tr>
    <tr>
    	<td>前置条件</td>
        <td>日期和仓库输入合法</td></tr>
    <tr>
  ...
  <tr>
    	<td rowspan="3">Inventory.exportExcel</td>
        <td>语法</td>
        <td>public ResultMessage exportExcel(InventoryCheckVO);</td></tr>
    <tr>
    	<td>前置条件</td>
        <td>已进行库存盘点</td></tr>
    <tr>
  ...
  <tr>
    	<td rowspan="3">Inventory.showAlarmBills</td>
        <td>语法</td>
        <td>public ArrayList&lt;InventoryBillVO&gt; showAlarmBills();</td></tr>
    <tr>
    	<td>前置条件</td>
        <td>以库存管理人员身份登录</td></tr>
    <tr>
  ...
  <tr>
    	<td rowspan="3">Inventory.findBill</td>
        <td>语法</td>
        <td>public ArrayList&lt;InventoryBillVO&gt; findBill(Date startDate, Date endDate, String account, String id, String keyword);</td></tr>
    <tr>
    	<td>前置条件</td>
  ...
  <tr>
    	<td rowspan="3">Inventory.addInventory</td>
        <td>语法</td>
        <td>public ResultMessage addInventory(String account);</td></tr>
    <tr>
    	<td>前置条件</td>
        <td>仓库名字输入非空</td></tr>
    <tr>
  ...
  <tr>
    	<td rowspan="3">Inventory.addBill</td>
        <td>语法</td>
    ...
    <tr>
   		<td>后置条件</td>
        <td>生成库存报损单/报溢单/赠送单草稿，持久化更新涉及的对象的数据</td>
    </tr>
  <tr>
    	<td rowspan="3">Inventory.deleteInventory</td>
        <td>语法</td>
        <td>public ResultMessage deleteInventory(String account);</td></tr>
    <tr>
    	<td>前置条件</td>
        <td>仓库名字已存在</td></tr>
    <tr>
  ...
  <tr>
  <tr>
    	<td rowspan="3">Inventory.updateInventory</td>
        <td>语法</td>
    ...
    <tr>
    	...
    	<td rowspan="3">Inventory.updateBill</td>
        <td>语法</td>
  ...
  <tr>
    ...
    <tr>
    <td>Inventory.showInventory()</td>
    <td colspan="2">返回所有仓库名字的持久化对象</td>
    </tr>
    <tr>
    <td>Inventory.showBills()</td>
    <td colspan="2">返回所有库存报溢单、报损单和赠送单的单一持久化对象</td>
    </tr>
    <tr>
    <td>Inventory.showAlarmBill()</td>
    <td colspan="2">返回所有库存报警单的单一持久化对象</td>
    </tr>
    <tr>
    ...
    <tr>
    <td>Inventory.addInventory(String account)</td>
    ...
    <tr>
    <td>Inventory.deleteInventory(String account)</td>
    <td colspan="2">添加单一持久化对象</td>
    </tr>
    <tr>
    ...
    <tr>
    <td>Inventory.updateInventory(String before, String after)</td>
    <td colspan="2">添加单一持久化对象</td>
    </tr>
    <tr>
...
tr>
      ...
      <td>语法</td>
      <td>public String getNewCustomerID()</td></tr>
...
<tr>
 ...
 <tr>
  ...
  <tr>
   ...
   <tr>
      ...
      <td>语法</td>
      <td>public PurchaseVO addPurchase(PurchaseVO vo)</td></tr>
  ...
  <tr>
      ...
      <td>语法</td>
      <td>public void addGoodsItem(GoodsItemVO item)</td></tr>
  ...
  <tr>
   ...
   <tr>
      ...
      <td>语法</td>
      <td>public SalesVO addSales(SalesVO vo)</td></tr>
 ...
 <tr>
      ...
      <td>语法</td>
      <td>public salesVO saveSales(SalesVO bill)</td></tr>
...
<tr>
      ...
      <td>语法</td>
      <td>public PurchaseVO savePurchase(PurchaseVO bill)</td></tr>
...
<tr>
  ...
  <td>SalesDataService.findPurchase(String ID)</td>
  ...
  <td>SalesDataService.findSales(String ID)</td>
...
* 表5.3.2-7 examinationbl模块的接口规范
  ...
  <tr>
        ...
        <td>语法</td>
        <td>public BillVO checkReceipt(String billID);</td></tr>
    <tr>
    	<td>前置条件</td>
        <td>存在待审核单据</td></tr>
    <tr>
    ...
    <tr>
        ...
        <td>语法</td>
        <td>public ResultMessage modifyReceipt(BillVO receipt);</td></tr>
    <tr>
    	<td>前置条件</td>
        <td>已查看单据内容</td></tr>
    <tr>
     ...
     <tr>
        ...
        <td>语法</td>
        <td>public ResultMessage approveReceipt(BillVO receipt);</td></tr>
    <tr>
    	<td>前置条件</td>
    ...
    <tr>
        ...
        <td>修改单据状态，记录审批时间并更新数据</td>
         ...
         <tr>
    	<td rowspan="3">Examination.showHistory</td>
        <td>语法</td>
        <td>public ArrayList&lt;BillVO&gt; showHistory();</td></tr>
    <tr>
    	<td>前置条件</td>
        <td>无</td></tr>
    <tr>
    ...
    <th colspan="2">服务</th>
     ...
     <tr>
    <td>ExaminationDataService.find(String ID)</td>
    <td colspan="2">根据bill的ID进行查找单一持久化对象</td>
    </tr>
    <tr>
...
* 表5.3.2-8 promotionCustomer模块的接口规范
  ...
  <tr>
    ...
    <tr>
    	<td rowspan="3">PromotionCustomer.setCustomer</td>
        <td>语法</td>
        <td>public void setCustomer(Level level);</td></tr>
    <tr>
    	<td>前置条件</td>
        <td>输入合法</td></tr>
    <tr>
   		<td>后置条件</td>
        <td>设置会员促销策略针对的会员等级</td>
    </tr>
         <tr>
  ...
  <tr>
    ...
    <tr>
        ...
        <td>提交促销策略</td>
            ...
            <tr>
    	<td rowspan="3">PromotionCustomer.findPromotionByID</td>
        <td>语法</td>
...
* 表5.3.2-9 promotionBargain模块的接口规范
  ...
  <tr>
    ...
    <tr>
  	...
  	<tr>
    	<td rowspan="3">PromotionBargain.findPromotionByID</td>
        <td>语法</td>
...
* 表5.3.2-10 promotionTotal模块的接口规范
  ...
  <tr>
    ...
    <tr>
        ...
        <tr>
    	<td rowspan="3">PromotionTotal.findPromotionByID</td>
        <td>语法</td>
  ...
  <tr>
    ...
    <tr>
        ...
        <td>根据用户ID查找相应用户并更改用户信息</td>
         ...
         <tr>
    	<td rowspan="3">User.findUserByID</td>
        <td>语法</td>
...
* 表 5.3.2-12 goodsbl模块的接口规范
  ...
  <tr>
    	<td rowspan="3">Goods.getNewID</td>
        <td>语法</td>
...
* 表 5.3.2-13 classificationbl模块的接口规范
  ...
  <tr>
    	<td rowspan="3">Classification.getNewID</td>
        <td>语法</td>
        <td>public String getNewID();</td></tr>
    <tr>
    	<td>前置条件</td>
...
* 表5.3.2-1 InventoryDataService模块的接口规范
  ...
  <tr>
    ...
    <tr>
   		<td>后置条件</td>
        <td>返回所有库存报溢单、报损单和赠送单的po对象</td>
    </tr>
  <tr>
    	<td rowspan="3">InventoryDataService.showInventory</td>
        <td>语法</td>
        <td>public ArrayList&lt;String&gt; showInventory() throws RemoteException;</td></tr>
    <tr>
    	<td>前置条件</td>
        <td>无</td></tr>
    <tr>
  ...
  <tr>
    	<td rowspan="3">InventoryDataService.showAlarm</td>
        <td>语法</td>
        <td>public ArrayList&lt;InventoryBillPO&gt; showAlarm() throws RemoteException;</td></tr>
    <tr>
    	<td>前置条件</td>
        <td>无</td></tr>
    <tr>
   		<td>后置条件</td>
        <td>返回所有库存报警单的po对象</td>
    </tr>
  <tr>
  ...
  <tr>
        ...
        <td>语法</td>
        <td>public ResultMessage addInventroy(String account) throws RemoteException;</td></tr>
    <tr>
    	<td>前置条件</td>
        <td>同名仓库不存在</td></tr>
    <tr>
  ...
  <tr>
        ...
        <td>语法</td>
        <td>public ResultMessage deleteInventory(String account) throws RemoteException;</td></tr>
    <tr>
    	<td>前置条件</td>
        <td>同名仓库已存在</td></tr>
    <tr>
  ...
  <tr>
        ...
        <td>语法</td>
        <td>public ResultMessage updateInventory(String before, String after) throws RemoteException;</td></tr>
    <tr>
    	<td>前置条件</td>
        <td>同名仓库已存在</td></tr>
    <tr>
...
<tr>
  ...
  <tr>
        ...
        <td>语法</td>
        <td>public CustomerPO getCustomerData() throws RemoteException</td></tr>
    <tr>
    	<td>前置条件</td>
...
<table>
  ...
  <tr>
        ...
        <td>语法</td>
        <td>public SalesPO findPurchaseByID(String ID) throws RemoteException</td></tr>
    <tr>
    	<td>前置条件</td>
    ...
    <tr>
        ...
        <td>语法</td>
        <td>public SalesPO findPurchaseByState(BillState state) throws RemoteException</td></tr>
    <tr>
    	<td>前置条件</td>
        <td>无</td></tr>
    <tr>
    ...
    <tr>
     ...
     <tr>
        ...
        <td>语法</td>
        <td>public SalesPO findSalesByState(BillState state) throws RemoteException</td></tr>
    <tr>
    	<td>前置条件</td>
        <td>无</td></tr>
    <tr>
...
<tr>
  ...
  <tr>
        ...
        <td>语法</td>
        <td>public ArrayList &lt;SalesVO&gt; showPurchase() throws RemoteException</td></tr>
    <tr>
    	<td>前置条件</td>
        <td>无</td></tr>
    <tr>
  ...
  <tr>
        ...
        <td>语法</td>
        <td>public ArrayList &lt;SalesVO&gt; showSales() throws RemoteException</td></tr>
    <tr>
    	<td>前置条件</td>
        <td>无</td></tr>
    <tr>
...
* 表5.3.2-8 ExaminationDataService模块的接口规范
  <table>
  <tr>
  	<th colspan="3" align="center">提供的服务（供接口）</th>
  </tr>
  <tr>
    	...
    	<td>语法</td>
    	<td>public ArrayList&lt;BillPO&gt; finds(Date startDate, Date endDate) throws RemoteException;</td></tr>
  <tr>
    	<td>前置条件</td>
    	<td>无</td></tr>
  <tr>
   		<td>后置条件</td>
    	<td>按审批时间段查找返回相应的BillPO结果</td>
  </tr>
  <tr>
    	<td rowspan="3">ExaminationDataService.find</td>
    	<td>语法</td>
    	<td>public BillPO find(String ID) throws RemoteException;</td></tr>
  <tr>
    	<td>前置条件</td>
    	<td>无</td></tr>
  <tr>
   		<td>后置条件</td>
    	<td>按bill的的ID查找返回相应的BillPO结果</td>
  </tr>
  <tr>
...
* 表5.3.2-9 PromotionDataService模块的接口规范
  <table>
  <tr>
  	<th colspan="3" align="center">提供的服务（供接口）</th>
  </tr>
  <tr>
    	...
    	<td>语法</td>
    	<td>public String getID() throws RemoteException;</td></tr>
  <tr>
    	<td>前置条件</td>
    	<td>无</td></tr>
  <tr>
  ...
  <tr>
        ...
        <td>语法</td>
        <td>public PromotionPO find(String ID) throws RemoteException;</td></tr>
    <tr>
    	<td>前置条件</td>
        <td>无</td></tr>
    <tr>
...
* 表5.3.2-10 UserDataService模块的接口规范
  <table>
  <tr>
  	<th colspan="3" align="center">提供的服务（供接口）</th>
  </tr>
...
* 表5.3.2-11 GoodsDataService模块的接口规范
  <table>
  <tr>
  	<th colspan="3" align="center">提供的服务（供接口）</th>
  </tr>
...
* 表5.3.2-11 ClassificationDataService模块的接口规范
  ...
  <tr>
        ...
        <td>语法</td>
        <td>public ClassificationPO find(String id) throws RemoteException;</td></tr>
    <tr>
    	<td>前置条件</td>
        <td>ID输入合法</td></tr>
    <tr>

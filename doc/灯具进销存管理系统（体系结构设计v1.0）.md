...
* 表 5.3.2-1 inventorybl模块的接口规范
  ...
  <tr>
        ...
        <td>语法</td>
        <td>public ArrayList&lt;InventoryBillVO&gt; findBill(Date startDate, Date endDate, String inventory, String id, String keyword);</td></tr>
    <tr>
    	<td>前置条件</td>
  ...
  <tr>
    ...
    <tr>
    <td>Inventory.addInventory(String inventory)</td>
    ...
    <tr>
    <td>Inventory.deleteInventory(String inventory)</td>
    <td colspan="2">添加单一持久化对象</td>
    </tr>
    <tr>
...
* 表5.3.2-1 InventoryDataService模块的接口规范
  ...
  <tr>
        ...
        <td>语法</td>
        <td>public ResultMessage addInventroy(String inventory) throws RemoteException;</td></tr>
    <tr>
    	<td>前置条件</td>
        <td>同名仓库不存在</td></tr>
    <tr>
  ...
  <tr>
        ...
        <td>语法</td>
        <td>public ResultMessage deleteInventory(String inventory) throws RemoteException;</td></tr>
    <tr>
    	<td>前置条件</td>
        <td>同名仓库已存在</td></tr>
    <tr>
...
<tr>
        ...
        <td>语法</td>
        <td>public CustomerVO findByCustomerID(String customerID) throws RemoteException</td></tr>
    <tr>
    	<td>前置条件</td>
    ...
    <tr>
        ...
        <td>语法</td>
        <td>public CustomerVO findByKeywords(String keywords) throws RemoteException</td></tr>
    <tr>
    	<td>前置条件</td>
        <td>需要查找的客户PO在储存的数据中已经存在</td></tr>
    <tr>
...
<table>
  ...
  <tr>
    	<td rowspan="3">SalesDataService.findPurchase</td>
        <td>语法</td>
        <td>public SalesPO findPurchase(String ID) throws RemoteException</td></tr>
    <tr>
    	<td>前置条件</td>
    ...
    <tr>
    	<td rowspan="3">SalesDataService.findSales</td>
        <td>语法</td>
        <td>public SalesPO findSales(String ID) throws RemoteException</td></tr>
    <tr>
    	<td>前置条件</td>
        <td>同样ID的po在储存的数据中不存在</td></tr>
    <tr>

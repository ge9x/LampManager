...
<tr>
      ...
      <td>语法</td>
      <td>public ResultMessage addCustomer(String kind,String level,String name,String phoneNumber,String address,String postcode,String mail,String receivableQuota,String receive,String pay,UserVO salesman)</td></tr>
...
<tr>
  	...
  	<td rowspan="3">Customer.seekCustomer</td>

      <td>语法</td>
      <td>public ResultMessage seekCustomer(String keywords,long customerId)</td></tr>
...
<tr>
  	...
  	<td rowspan="3">Customer.modifyCustomer</td>

      <td>语法</td>
      <td>public ResultMessage modifyCustomer(String kind,String level,String name,String phoneNumber,String address,String postcode,String mail,String receivableQuota,String receive,String pay,UserVO salesman);</td></tr>
  ...
  <td>CustomerDataService.addCustomer(CustomerPO po)</td>
  ...
  <td>CustomerDataService.deleteCustomer(CustomerPO po)</td>

  <td colspan="2">单一删除持久化对象</td>

  </tr>
  <tr>

  <td>CustomerDataService.seekCustomer(long customerID)</td>

  <td colspan="2">根据客户ID查找单一化持久对象</td>

  </tr>
  <tr>

  <td>CustomerDataService.seekCustomer(String keywords)</td>
  ...
  <td>CustomerDataService.modifyCustomer(CustomerPO po)</td>
...
<tr>
 ...
 <tr>
  	...
  	<td rowspan="3">Sales.seekFitPromotionCustomer</td>

      <td>语法</td>
      <td>public ArrayList &lt;PromotionCustomerVO&gt; seekFitPromotionCustomer()</td></tr>
 ...
 <tr>
  	...
  	<td rowspan="3">Sales.seekFitPromotionTotal</td>

      <td>语法</td>
      <td>public ArrayList &lt;PromotionTotalVO&gt; seekFitPromotionTotal()</td></tr>
  ...
  <tr>
   ...
   <tr>
      ...
      <td>语法</td>
      <td>public purchaseVO bulidPurchase()</td></tr>
  ...
  <tr>
   ...
   <tr>
      ...
      <td>语法</td>
      <td>public SalesVO addSalesItem()</td></tr>
 ...
 <tr>
  	...
  	<td rowspan="3">Sales.submit</td>

      <td>语法</td>
      <td>public SalesVO Submit(salesBillVO bill)</td></tr>
 ...
 <tr>
      ...
      <td>语法</td>
      <td>public salesVO save(salesBillVO bill)</td></tr>
...
<tr>
  ...
  <td>SalesDataService.seek(String ID)</td>
  ...
  <td>SalesDataService.modify(salesPO po)</td>
  ...
  * 表5.3.2-4 initAccountbl模块的接口规范
<table>
	<tr>
		<th colspan="3" align="center">提供的服务（供接口）</th>
	</tr>
<tr>
    	<td rowspan="3">InitAccount.add</td>
    	<td>语法</td>
    	<td>public ResultMessage add(ArrayList&lt;GoodsVO&gt; goods, ArrayList&lt;CustomerVO&gt; customers, ArrayList&lt;AccountVO&gt; accounts);</td></tr>
<tr>
    	<td>前置条件</td>
...
<tr>
    	<td rowspan="3">InitAccount.getAverage</td>
        <td>语法</td>
    ...
    <tr>
    <td>InitAccountDataService.init()</td>
    <td colspan="2">初始化持久数据</td>
    </tr>
    <tr>
    <td>InitAccountDataService.insert(ExaminationPO po)</td>
    <td colspan="2">插入单一持久化对象</td>
    </tr>
</table>
...
<tr>
    ...
    <tr>
    <td>ExaminationDataService.insert(ExaminationPO po)</td>
    <td colspan="2">插入单一持久化对象</td>
    </tr>
</table>
...
<table>
  ...
  <tr>
    ...
    <tr>
    <td>PromotionDataService.insert(PromotionCustomerPO po)</td>
    <td colspan="2">插入单一持久化对象</td>
    </tr>
    <tr>
...
<table>
  ...
  <tr>
    ...
    <tr>
    <td>PromotionDataService.insert(PromotionBargainPO po)</td>
    <td colspan="2">插入单一持久化对象</td>
    </tr>
    <tr>
...
<table>
  ...
  <tr>
    ...
    <tr>
    <td>PromotionDataService.insert(PromotionTotalPO po)</td>
    <td colspan="2">插入单一持久化对象</td>
    </tr>
    <tr>
...
### 5.4.2 数据层模块的接口规范
* 表5.3.2-4 InitAccountDataService模块的接口规范
<table>
	<tr>
		<th colspan="3" align="center">提供的服务（供接口）</th>
	</tr>
...
<tr>
    	<td rowspan="3">ExaminationDataService.insert</td>
        <td>语法</td>
        <td>public ResultMessage insert(ExaminationPO po) throws RemoteException;</td></tr>
    <tr>
    	<td>前置条件</td>
        <td>同样的po在数据中不存在</td></tr>
    <tr>
...
<tr>
    ...
    <tr>
        ...
        <td>语法</td>
        <td>public ResultMessage insert(PromotionPO po) throws RemoteException;</td></tr>
    <tr>
    	<td>前置条件</td>
        <td>同样的po在数据中不存在</td></tr>
    <tr>
...
<tr>
    ...
    <tr>
        ...
        <td>语法</td>
        <td>public ResultMessage insert(UserPO po) throws RemoteException;</td></tr>
    <tr>
    	<td>前置条件</td>
        <td>同样的po在数据中不存在</td></tr>
    <tr>

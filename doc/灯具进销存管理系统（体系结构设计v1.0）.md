...
* 表5.3.2-8 ExaminationDataService模块的接口规范
  ...
  <tr>
    	...
    	<td>语法</td>
    	<td>public ArrayList&lt;ExaminationPO&gt; finds(Date startDate, Date endDate) throws RemoteException;</td></tr>
  <tr>
    	<td>前置条件</td>
    	<td>无</td></tr>
  <tr>
   		<td>后置条件</td>
    	<td>按审批时间段查找返回相应的ExaminationPO结果</td>
  </tr>
  <tr>

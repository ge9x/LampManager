...
<tr>
        ...
        <td>语法</td>
        <td>public CustomerVO findByCustomerID(long customerID)</td></tr>
    <tr>
    	<td>前置条件</td>
    ...
    <tr>
        ...
        <td>语法</td>
        <td>public CustomerVO findByKeywords(String keywords)</td></tr>
    <tr>
    	<td>前置条件</td>
        <td>需要查找的客户PO在储存的数据中已经存在</td></tr>
    <tr>
...
<tr>
        ...
        <td>语法</td>
        <td>public ArrayList &lt;CustomerPO&gt; show()</td></tr>
    <tr>
    	<td>前置条件</td>
        <td>无</td></tr>
    <tr>

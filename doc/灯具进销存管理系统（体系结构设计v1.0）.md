...
<tr>
      ...
      <td>语法</td>
      <td>public ResultMessage findCustomer(String keywords,String customerID)</td></tr>
...
<tr>
  ...
  <td>CustomerDataService.find(String customerID)</td>
 ...
 <tr>
  ...
  <tr>
   ...
   <tr>
      ...
      <td>语法</td>
      <td>public SalesVO addSalesItem(SalesVO vo)</td></tr>
...
<tr>
        ...
        <td>语法</td>
        <td>public ResultMessage checkReceipt(BillVO receipt);</td></tr>
    <tr>
    	<td>前置条件</td>
        <td>存在待审核单据</td></tr>
    <tr>

...
<tr>
    ...
    <tr>
 	...
 	<tr>
        ...
        <td>语法</td>
        <td>public ResultMessage deleteBill(ClassificationPO po) throws RemoteException;</td></tr>
    <tr>
    	<td>前置条件</td>
        <td>数据库中有同一ID的po对象</td></tr>
    <tr>
 	...
 	<tr>
        ...
        <td>语法</td>
        <td>public ResultMessage updateBill(ClassificationPO po) throws RemoteException;</td></tr>
    <tr>
    	<td>前置条件</td>
        <td>数据库中有同一ID的po对象</td></tr>
    <tr>

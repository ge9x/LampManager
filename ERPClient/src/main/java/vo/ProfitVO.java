...
public class ProfitVO {
     ...
     * 开始时间
     */
    @ExcelColumnName(value = "开始时间")
    public String startDate;

    /**
     * 结束时间
     */
    @ExcelColumnName(value = "结束时间")
    public String endDate;

    /**
     * 销售收入
     */
    @ExcelColumnName(value = "销售收入")
    public double salesIncome;

    /**
     * 商品报溢收入
     */
    @ExcelColumnName(value = "商品报溢收入")
    public double overflowIncome;

    /**
     * 成本调价收入
     */
    @ExcelColumnName(value = "成本调价收入")
    public double costAdjIncome;

    /**
     * 进货退货差价
     */
    @ExcelColumnName(value = "进货退货差价")
    public double buyAndReturnIncome;

    /**
     * 代金券与实际收款差额收入
     */
    @ExcelColumnName(value = "代金券与实际收款差额收入")
    public double voucherIncome;

    /**
     * 折让后总收入
     */
    @ExcelColumnName(value = "折让后总收入")
    public double totalIncome;

    /**
     * 折让
     */
    @ExcelColumnName(value = "折让")
    public double allowance;

    /**
     * 销售成本
     */
    @ExcelColumnName(value = "销售成本")
    public double salescost;

    /**
     * 商品报损
     */
    @ExcelColumnName(value = "商品报损")
    public double lossExpense;

    /**
     * 商品赠出
     */
    @ExcelColumnName(value = "商品赠出")
    public double giftExpense;

    /**
     * 总支出
     */
    @ExcelColumnName(value = "总支出")
    public double totalExpense;

    /**
     * 利润
     */
    @ExcelColumnName(value = "利润")

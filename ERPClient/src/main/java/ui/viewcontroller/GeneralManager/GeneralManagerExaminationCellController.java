...
public class GeneralManagerExaminationCellController {
	...
	public void setBillType(BillVO bill){
		if(bill.type==BillType.CASH){
			...
			billMoney.setText(String.valueOf(cashBill.sum));
		}
			...
			billMoney.setText(String.valueOf(accountBill.sum));
		}
			...
			billMoney.setText(String.valueOf(purchaseBill.sum));
		}
			...
			billMoney.setText(String.valueOf(salesBill.afterSum));
		}

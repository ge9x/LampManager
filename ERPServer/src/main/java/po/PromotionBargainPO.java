...
public class PromotionBargainPO extends PromotionPO implements Serializable{
	private static final long serialVersionUID = 473563454384937534L;
	/** 编号 */
	private int ID;
	/**促销策略名字*/
	...
	public String toString(){
		return "促销策略编号:" + promotionID + ", 促销策略名称:" + promotionName + ", 促销策略类型:" + type.getValue() +  ", 开始日期:" + startDate
				+ ", 结束日期:" + endDate + ", 特价包商品原价总额:" + goodsTotal + ", 特价包价格:" + bargainTotal;
	}
